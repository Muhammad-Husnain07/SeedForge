...
const SCHEMA_PATH = '../../fixtures/ecommerce/schema.prisma';
...
const CANONICAL: Omit<TableSchema, 'columns'> & { columns: { name: string; logicalType: string; nullable: boolean; isPrimaryKey: boolean; isUnique: boolean; enumValues?: string[]; maxLength?: number; precision?: number; scale?: number }[] }[] = [
  {
    ...
    columns: [
      { name: 'id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
      ...
      { name: 'unit_price', logicalType: 'float', nullable: false, isPrimaryKey: false, isUnique: false },
    ],
    foreignKeys: [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'total', logicalType: 'float', nullable: false, isPrimaryKey: false, isUnique: false },
  ...
  },
  {
    ...
    columns: [
      { name: 'product_id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
      { name: 'tag_id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
    ],
    foreignKeys: [
      { columns: ['product_id'], referencedTable: 'products', referencedColumns: ['id'], onDelete: 'cascade' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
      { name: 'name', logicalType: 'string', nullable: false, isPrimaryKey: false, isUnique: false },
      { name: 'price', logicalType: 'float', nullable: false, isPrimaryKey: false, isUnique: false },
      { name: 'sku', logicalType: 'string', nullable: false, isPrimaryKey: false, isUnique: true },
    ],
    foreignKeys: [],
  ...
  },
  {
    ...
    columns: [
      { name: 'id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
      { name: 'name', logicalType: 'string', nullable: false, isPrimaryKey: false, isUnique: true },
    ],
    foreignKeys: [],
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'first_name', logicalType: 'string', nullable: false, isPrimaryKey: false, isUnique: false },
      { name: 'id', logicalType: 'uuid', nullable: false, isPrimaryKey: true, isUnique: false },
      { name: 'is_active', logicalType: 'boolean', nullable: false, isPrimaryKey: false, isUnique: false },
      { name: 'last_name', logicalType: 'string', nullable: false, isPrimaryKey: false, isUnique: false },
    ...
    foreignKeys: [
      { columns: ['referred_by'], referencedTable: 'users', referencedColumns: ['id'], onDelete: 'setnull' },
    ],
...
describe('Prisma introspection', () => {
  ...
  it('should detect self-referential FK on users.referred_by', async () => {
    ...
    expect(referredFk!.onDelete).toBe('setnull');
  });
