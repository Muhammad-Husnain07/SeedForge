...
export default defineConfig({
  connection: {
    dialect: 'postgres',
    connectionString: 'postgresql://seedforge:seedforge@localhost:5432/seedforge',
  },
  tables: {
    users: {
      count: 10,
    ...
    products: {
      count: 5,
      fields: { id: { kind: 'uuid', params: {} }, name: { kind: 'fullName', params: {} } },
    },
    tags: {
      count: 3,
      fields: { id: { kind: 'uuid', params: {} }, name: { kind: 'slug', params: {} } },
    },
    product_tags: { count: 8, fields: { product_id: { kind: 'uuid', params: {} }, tag_id: { kind: 'uuid', params: {} } } },
    orders: {
    ...
    reviews: {
      ...
      fields: { id: { kind: 'uuid', params: {} }, product_id: { kind: 'uuid', params: {} }, user_id: { kind: 'uuid', params: {} } },
    },
  },
});
